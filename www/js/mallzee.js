ionic.Platform.ready(function ($ionicPlatform) {
    ...
    console.log($ionicPlatform.isWebView())
}),
    ...
    function (a) {
        ...
        function c(c, e) {
            return {
                ...
                request: function (c, f, g, h, i, j) {
                    i ? a.extend(i, d.headers) : i = d.headers;
                    var k;
                    g && (k = {},
                        a.copy(g, k), b(k));
                    var l = {
                    ...
                    return j ? a.extend(j, l) : j = l,
                        e(j)
                },
                store: {
                    get: function (a) {
                        return JSON.parse(c.localStorage.getItem(a))
                    },
                    set: function (b, d) {
                        return d = a.isObject(d) ? JSON.stringify(d) : d,
                            c.localStorage.setItem(b, d)
                    },
                    remove: function (a) {
        ...
        var d = {
            ...
            e = function () {
                this.getBaseUrl = function () {
                    ...
                    this.$get = ["Base", "Resource",
                        function (a, b) {
                            var c = this;
                            return {
                                getBaseUrl: c.getBaseUrl,
                                setBaseUrl: c.setBaseUrl,
        ...
        a.module("mallzee.base", []).service("Base", ["$window", "$http", c]),
            a.module("mallzee.service", ["mallzee.base", "mallzee.models", "mallzee.resources", "mallzee.services"]).provider("MallzeeService", e)
    }(angular),
    function (a) {
        "use strict";
        var b = function (a) {
            ...
            return b = function () {
                ...
                return b.prototype.setData = function (a) {
                    ...
                    b.prototype.refresh = function () {
                        var b = this;
                        return a.request("GET", this.$$path + "/" + this[this.$$identifier]).then(function (a) {
        ...
        a.module("mallzee.models", ["mallzee.base"]).factory("Model", ["Base", b])
    }(angular),
    function (a, b) {
        "use strict";
    ...
    function (a) {
            ...
            return c = function () {
                ...
                return c.prototype = new b,
                    ...
                    c.prototype.refresh = function () {
                        var b = this;
                        return a.request("GET", this.$$path).then(function (c) {
                            return b.setData(c.data),
                                a.store.set("me", b),
                                b
                        })
                    },
                    c.prototype.save = function () {
                        var b = this;
                        return a.request("PUT", d, this).then(function (c) {
                            return a.store.set("me", b),
                                c.data
                        })
                    },
                    c
        ...
        a.module("mallzee.models").service("User", ["Base", "Model", "Brand", b])
    }(angular),
    function () {
        "use strict";
            ...
            function (a, b) {
                return {
                    isAuthenticated: function () {
                        return console.log("Is authenticated?", b.get("authenticated"), b.cookie.get("session")),
                            !1
                    },
    ...
    function (a) {
        "use strict";
        a.module("mallzee.services").factory("AuthenticationService", ["$rootScope", "Base", "User",
            function (a, b, c) {
                var d = "authenticate",
                    e = function (e) {
                        return b.request("POST", d, e).then(function (d) {
                    ...
                    f = function (a) {
                        return b.getHeader("Authorization") === "Bearer " + a.token
                    },
                    g = function (c) {
                        c.token && (b.setHeader("Authorization", "Bearer " + c.token), a.$broadcast("user.authenticated", c))
                    },
                    h = function () {
...
!
    function (a, b) {
        a.module("templates-main", []);
        var c = a.module("runway", ["ionic", "ngCordova", "angularMoment", "localytics", "hockeyapp", "mallzee.ionic", "mallzee.service", "mallzee.filters", "mallzee.images", "mallzee.services.unknownstates", "runway.controllers", "runway.services", "templates-main"]);
        c.constant("BaseUrl", "http://runway.mallzee.com"),
            c.provider("Me", [function () {
                this.$get = ["Base", "User",
                    function (a, b) {
                        var c = a.store.get("me") ? new b(a.store.get("me")) : new b;
                        return c
                    }]
            }]),
            c.factory("NetworkActivity", ["$cordovaDialogs",
                function (c) {
                    function d() {
            ...
            c.factory("PushState", ["$rootScope", "$state",
                function (a, b) {
            ...
            c.factory("UnauthorizedInterceptor", ["$q", "$injector",
                function (a, b) {
                    return {
                        responseError: function (c) {
                            var d = b.get("$state");
                            return console.log("Response error", c, d),
                                401 === c.status && d.current.authenticated && d.go("login"),
                                a.reject(c)
                        }
                    }
                }]),
            c.config(["$urlRouterProvider", "$sceProvider", "$httpProvider", "$hockeyappProvider", "$ionicConfigProvider", "MallzeeServiceProvider",
                function (a, b, c, d, e, f) {
                    b.enabled(!1),
                        a.otherwise("/inspiration"),
                        c.interceptors.push("UnauthorizedInterceptor"),
                        c.defaults.useXDomain = !0,
                        delete c.defaults.headers.common["X-Requested-With"],
                        d.setAppId("360b490473aa28593f67b208c53d8cc3"),
                        f.setBaseUrl("https://api.mallzee.com/")
                }]),
            c.run(["$rootScope", "$state", "$window", "$cordovaStatusbar", "$cordovaPush", "Me", "PushState", "AuthenticationService", "BrandsResource", "UserProductsResource", "StyleFeedsResource", "OpenUrlService",
                function (a, c, d, e, f, g, h, i) {
                    i.load(g),
                        g.refresh().then(function (a) {
                            console.log("Me", a),
                                a.settings.swipes = 0
                        }),
                        a.$on("$stateChangeStart",
                            function (a, b) {
                                b.authenticated !== !0 || i.isAuthenticated(g) || (c.go("welcome"), a.preventDefault())
                            }),
                        ...
                        ionic.Platform.isWebView() && facebookConnectPlugin.getLoginStatus(function (a) {
                                g.facebookStatus = a
                            },
                            function (a) {
                                console.log("Facebook status error", a)
                            }),
                        a.$on("notification.push",
                            function (a, b) {
                                "tab.brand" !== b.state || b.foreground || setTimeout(function () {
                                    c.go("tab.brands"),
                                        setTimeout(function () {
                                            c.go("tab.products-brand", {
                                                brand: b.brand
                                            })
                                        })
                                })
    ...
    function (a) {
        ...
        a.module("hockeyapp", []).provider("$hockeyapp", [function () {
            this.appId = "",
                ...
                this.$get = [function () {
                    return "hockeyapp" in window && (b = window.hockeyapp),
                        this.appId ? (b.start(this.successFn, this.errorFn, this.appId), document.addEventListener("backbutton",
                            function () {
                            },
                            !1)) : console.log("[HockeyApp][Error] No app id set"),
                        b
                }]
        }]),
            a.module("hockeyapp").run(["$hockeyapp",
                function () {
                }])
    }(angular),
    function (a) {
    ...
    function () {
        "use strict";
        angular.module("runway.controllers.login", []).config(["$stateProvider",
                function (a) {
                    a.state("welcome", {
                        url: "/welcome",
                ...
                }]).controller("LoginCtrl", ["$scope", "$state", "$http", "$localytics", "$ionicPopup", "$ionicLoading", "AuthenticationService", "Me",
                function (a, b, c, d, e, f, g, h) {
                    a.user = {
                        email: "",
                        password: "",
...
var ProductCtrl = ["$scope", "$state", "$timeout", "$localytics", "$ionicLoading", "$ionicScrollDelegate", "$ionicSlideBoxDelegate", "BrandModalService", "BrandsResource", "DeviceService", "ImagesModalService", "ProductModalService", "ProductsResource", "ProductsService", "Product", "ShareService", "Me",
...
angular.module("runway.controllers.products").config(["$stateProvider",
    ...
    function (a) {
        ...
        a.module("localytics", []).run(["$rootScope",
                function (a) {
                    function c() {
                        b.resume(),
                            b.upload()
                    ...
                    "Localytics" in window && (b = window.Localytics),
                        document.addEventListener("deviceready", c, !1),
                        document.addEventListener("resume", d, !1),
                        document.addEventListener("pause", e, !1),
                        a.$on("$stateChangeStart",
                            function (a, c) {
                                c.screen && b.tagScreen(c.screen)
                            })
                }]).service("$localytics", ["$rootScope",
                function (a) {
                    return a.$on("user.authenticated",
                        function (a, c) {
                        ...
                        b
                }]).directive("tagEvent", ["$localytics",
                function (a) {
                    return {
                        restrict: "A",
                        link: function (b, c, d) {
                            console.log("Localytics tag event directive"),
                                a.tagEvent(d.tagEvent, d.properties, d.value)
                        }
                    }
                }]).directive("tagScreen", ["$localytics",
                function (a) {
                    return {
                        restrict: "A",
                        link: function (b, c, d) {
                            a.tagScreen(d.tagScreen)
                        }
                    }
                }])
    }(angular),
