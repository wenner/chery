...
(function(xml2js) {
  //var bom, builder, events , processors, sax; 
  var escapeCDATA, isEmpty, processName, requiresCDATA, wrapCDATA,
  ...
  xml2js.Builder = (function() {
    function Builder(opts) {
      var key, ref, value;
      this.options = {};
      ref = xml2js.defaults["0.2"];
      for (key in ref) {
    ...
    Builder.prototype.buildObject = function(rootObj) {
      ...
      if ((Object.keys(rootObj).length === 1) && (this.options.rootName === xml2js.defaults['0.2'].rootName)) {
  ...
  xml2js.Parser = (function(superClass) {
    ...
    function Parser(opts) {
      ...
      var key, ref, value;
      if (!(this instanceof xml2js.Parser)) {
        return new xml2js.Parser(opts);
      }
      this.options = {};
      ref = xml2js.defaults["0.2"];
      for (key in ref) {
  ...
  xml2js.parseString = function(str, a, b) {
...
})(typeof exports === "undefined" ? xml2js = {} : exports);
